...
%% caffe setttings
matCaffe = fullfile(pwd, '../tools/caffe-sfplus/matlab');
...
%weights = '../train/result_normsoftmax/baseline/baseline_normsoftmax_model_iter_12000.caffemodel';
net     = caffe.Net(model, weights, 'test');
net.save('result/sfplus_model.caffemodel');
